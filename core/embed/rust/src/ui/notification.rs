...
static NOTIFICATION_LEVEL_TYPE: Type = obj_type! {
    ...
    locals: &obj_dict!(obj_map! {
        Qstr::MP_QSTR_ALERT => Obj::small_int(0u16),
        Qstr::MP_QSTR_WARNING => Obj::small_int(1u16),
        Qstr::MP_QSTR_INFO => Obj::small_int(2u16),
        Qstr::MP_QSTR_SUCCESS => Obj::small_int(3u16),
    }),
};
