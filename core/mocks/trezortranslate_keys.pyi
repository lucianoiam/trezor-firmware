...
class TR:
    ...
    reset__slip39_checklist_more_info_threshold: str = "The threshold sets the minimum number of shares needed to recover your wallet."
    ...
    storage_msg__pin_change: str = "Changing PIN"
    storage_msg__pin_remove: str = "Removing PIN"
    storage_msg__pin_setup: str = "Setting PIN"
